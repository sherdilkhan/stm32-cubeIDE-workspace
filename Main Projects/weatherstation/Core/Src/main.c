...
const osThreadAttr_t bme280Task_attributes = { .name = "bme280Task",
		.stack_size = 256 * 4, .priority = (osPriority_t) osPriorityNormal, };
/* Definitions for lcdTask */
osThreadId_t lcdTaskHandle;
const osThreadAttr_t lcdTask_attributes = { .name = "lcdTask", .stack_size = 256
...
const osMessageQueueAttr_t bme280Data_attributes = { .name = "bme280Data" };
