...
//      D0_GPIO_Port, D0_Pin, D1_Pin, D2_Pin, D3_Pin,
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	    lcd16x2_1stLine();
	    lcd16x2_printf("Mutex Firmware");
	    HAL_Delay(2000);
	    lcd16x2_2ndLine();
	    //lcd16x2_printf("%d C", 25);
	    lcd16x2_printf("LCD 4Bit Mode ");
	    HAL_Delay(2000);
	    lcd16x2_clear();
	    HAL_Delay(500);
  }
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, DO_Pin|D1_Pin|D2_Pin|D3_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : DO_Pin D1_Pin D2_Pin D3_Pin */
  GPIO_InitStruct.Pin = DO_Pin|D1_Pin|D2_Pin|D3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
